"use client";
import { Gift, BookUser, Package, ScrollText } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-[calc(100svh-340px)] w-full flex-col items-center justify-center pt-24 ">
      <div className=" flex h-fit w-fit flex-col items-center justify-center ">
        ...
        <div className="z-10 flex flex-col items-center justify-center gap-12 bg-transparent p-8 ">
          ...
          <div className=" flex flex-col items-center gap-6 px-4">
            <p className="text-balance text-center font-serif text-xl md:text-2xl">
