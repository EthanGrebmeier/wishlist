...
const Modal = ({ wishlist, wishlistShares, product, session }: ModalProps) => {
  ...
  return (
    <ResponsiveSheet trigger={<Button icon={<PackageCheck size={25} />}> </Button>} title="Received this item?">
      <ModalContent
        session={session}
...
const ModalContent = ({
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-4">
              <div className="flex flex-col">
                <p className="font-medium text-lg"> Confirm </p>
                <p className="text-sm">
                  {" "}
  ...
  return <AnimatePresence initial={false} mode="popLayout">{content}</AnimatePresence>;
};
