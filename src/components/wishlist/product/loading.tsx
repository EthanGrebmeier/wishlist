const ProductLoading = () => {
  return (
    ...
    >
      <section className="flex h-full w-full flex-1  flex-col gap-4 overflow-hidden transition-all lg:grid lg:grid-cols-[1fr_min-content] lg:gap-4">
        <div className="flex flex-1 justify-center gap-4 align-top lg:mx-0">
          <div className="skeleton relative flex flex-1  rounded-md border-2 border-black bg-white">
            <div className=" h-[240px] w-full lg:h-full"></div>
          </div>
        </div>
